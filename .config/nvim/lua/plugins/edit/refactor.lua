return {
	...
	keys = {
		--stylua: ignore
		{ "<leader>ri", ":Refactor inline_var<cr>",      desc = "refactor inline_var",  mode = { "n", "x" } },
		{ "<leader>rI", ":Refactor inline_func<cr>", desc = "refactor inline_func", mode = { "n", "x" } },
		{ "<leader>rv", ":Refactor extract_var<cr>", mode = "x", desc = "extract to func" },
		{ "<leader>rm", ":Refactor extract<cr>", mode = "x", desc = "extract to var" },
